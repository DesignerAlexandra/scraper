        ...
        foreach ($subgroups as $subgroup) {
            ...
            foreach ($subgroups as $subgroupForSubgroup) {
                ...
                foreach ($subgroupForSubgroups as $nextLevel) {    
                    ...
                    if($nextLevel != 'links.txt') {
                        continue;
                    }

                    $stream = fopen(STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nextLevel, 'r');
                    ...
                    while ($row = fgets($stream)) {
                        ...
                        $link = trim($row);
                            ...
                            if($checkElems) {
                                ...
                                if(!is_dir(STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup)) {

                                    mkdir(STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup, 0700);
                                
                                } 
                                if(!is_dir(STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup . '/images')) { 

                                    mkdir(STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup . '/images', 0700);

                                }

                                $newDir = STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup;
                                $newImgDir = STRUCT_DIR . '/' . $dir . '/' . $group . '/' . $subgroup . '/' . $subgroupForSubgroup . '/' . $nameGroup . '/images';
